...
import static junit.framework.TestCase.assertTrue;
        ...
        /*
        * Класс для проверки прохождения маршрута согласования заявки  типа "Пересмотр прав" (с доступами СКИБ)
        *
        * @author VO Losev
        */
...
public class ReviewAccess {
    ...
    public void reviewAccessRights() throws Exception {
        ...
        String updHRsource = "update hrsource.hremp h\n" +
                "set h.department_id = 'КМ3302902', h.department_id_full = '[1C-32][КМ3302902]', h.done = 0, h.source_id = '1C-32', h.employee_status = 'w', h.employment_weight = 100, \n" +
                "h.end_date = to_date ('10.04.2020 12:00:00','dd.mm.yyyy hh24:mi:ss'), h.title_id= '000000741', h.title_id_full = '[1C-32][000000741]' \n" +
                "where h.person_id like '%АБАТУРОВА%' \n";
        ...
        updHRsource = "update hrsource.hremp h\n" +
                "set h.department_id = 'КР3401222', h.department_id_full = '[1C-32][КР3401222]', h.done = 0, h.source_id = '1C-32', h.employee_status = 'w', h.employment_weight = 100, \n" +
                "h.end_date = to_date ('10.04.2020 12:00:00','dd.mm.yyyy hh24:mi:ss'), h.title_id= '000000868', h.title_id_full = '[1C-32][000000868]' \n" +
                "where h.person_id like '%АБАТУРОВА%'";
